...
def build_targets(pred_boxes, target, anchors, num_anchors, num_classes, nH, nW, noobject_scale, object_scale, sil_thresh, seen):
    ...
    for b in range(nB):
        ...
        #print(torch.reshape(cur_ious>sil_thresh, (nA, nH, nW))
...
class RegionLoss(nn.Module):
    def __init__(self, num_classes=0, anchors=[], num_anchors=1):
        ...
        self.thresh = 0.6
        self.seen = 0
        print("AS1", self.anchor_step)

    def forward(self, output, target):
        print("AS2", self.anchor_step)
        ...
        # print("mask", cls_mask.size())
        #print("tcls",tcls.size())
        #print("3,",tcls.view(-1)[cls_mask])
        #print("4",tcls.view(-1)[cls_mask].long())
        ...
        if False:
            ...
            print('             total : %f' % (t4 - t0))
        wandb.log({"nGT:": nGT, "loss_x": loss_x.data[0], "loss_y": loss_y.data[0], "loss_w":loss_w.data[0], "loss_h": loss_h.data[0]}) 
